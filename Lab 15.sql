---------------- Task 1 ---------------- 
-- Создайте таблицу, имеющую несколько атрибутов, один из которых первичный ключ.
...
---------------- Task 2 ---------------- 
-- Заполните таблицу строками (10 шт.)

INSERT INTO LW15TABLE(SOMETEXT, TEXTBEGINSWITHB)  VALUES ('hello1', 'BText1');
INSERT INTO LW15TABLE(SOMETEXT, TEXTBEGINSWITHB)  VALUES ('hello2', 'BText2');
INSERT INTO LW15TABLE(SOMETEXT, TEXTBEGINSWITHB)  VALUES ('hello3', 'BText3');
INSERT INTO LW15TABLE(SOMETEXT, TEXTBEGINSWITHB)  VALUES ('hello4', 'BText4');
INSERT INTO LW15TABLE(SOMETEXT)  VALUES ('hello5');
INSERT INTO LW15TABLE(SOMETEXT, TEXTBEGINSWITHB)  VALUES ('hello6', 'BText6');
INSERT INTO LW15TABLE(SOMETEXT, TEXTBEGINSWITHB)  VALUES ('hello7', 'BText7');
INSERT INTO LW15TABLE(SOMETEXT, TEXTBEGINSWITHB)  VALUES ('hello8', 'BText8');
INSERT INTO LW15TABLE(SOMETEXT, TEXTBEGINSWITHB)  VALUES ('hello9', 'BText9');
...
---------------- Task 6 ---------------- 
-- Примените предикаты INSERTING, UPDATING и DELETING.
...
---------------- Task 7 ---------------- 
-- Разработайте AFTER-триггеры уровня оператора на события INSERT, DELETE и UPDATE.
...
---------------- Task 9 ---------------- 
--Создайте таблицу с именем AUDIT. Таблица должна содержать поля: OperationDate,
...
---------------- Task 11 ---------------- 
-- Выполните операцию, нарушающую целостность таблицы по первичному ключу. Выясните, зарегистрировал ли триггер это событие.
...
---------------- Task 13 ---------------- 
-- Удалите (drop) таблицу AUDIT. Просмотрите состояние триггеров. Объясните результат. Измените триггеры.
...
---------------- Task 14 ---------------- 
-- Создайте представление над исходной таблицей. Разработайте INSTEADOF INSERT-триггер. Триггер должен добавлять строку в таблицу.
